...
#https://support.microsoft.com/en-us/help/4072698/windows-server-guidance-to-protect-against-the-speculative-execution
    ...
    write-verbose "Adding registry key to enable patch instalaltion:" -ForegroundColor DarkCyan
    ...
    write-verbose "Stopping Windows Update" -ForegroundColor DarkCyan
    [void](Net stop wuauserv)
    
    write-verbose "Starting Windows Update" -ForegroundColor DarkCyan
    [void](Net start wuauserv)

    #Enable the security feature (after installation)
    write-verbose "Enabling protection 1/3:"  -ForegroundColor DarkCyan
    ...
    write-verbose "Enabling protection 2/3:"  -ForegroundColor DarkCyan
    ...
    write-verbose "Enabling protection 3/3:"  -ForegroundColor DarkCyan
    ...
    write-verbose "Executing scans 1/2:"  -ForegroundColor DarkCyan

    #Scan
    [void]([wmiclass]"\root\ccm:SMS_Client").TriggerSchedule('{00000000-0000-0000-0000-000000000113}')

    write-verbose "Executing scans 2/2:"  -ForegroundColor DarkCyan
    
    #re-Scan
    [void]([wmiclass]"\root\ccm:SMS_Client").TriggerSchedule('{00000000-0000-0000-0000-000000000108}')

    write-verbose "Scanning for patches:"  -ForegroundColor DarkCyan
    ...
    write-verbose "List of available patches:"  -ForegroundColor DarkCyan
